...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, /* @__PURE__ */ Object.assign({ "./pages/accounts/index.tsx": () => import("./assets/index-QjyPwjnW.js"), "./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-CFuWNYwv.js"), "./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-C1yWYqXc.js"), "./pages/auth/login.tsx": () => import("./assets/login-C6WnSR3U.js"), "./pages/auth/register.tsx": () => import("./assets/register-aLshhUYf.js"), "./pages/auth/reset-password.tsx": () => import("./assets/reset-password-BGrYCUpE.js"), "./pages/auth/verify-email.tsx": () => import("./assets/verify-email-D38tHwWt.js"), "./pages/budgets/index.tsx": () => import("./assets/index-DTlYe4zA.js"), "./pages/dashboard.tsx": () => import("./assets/dashboard-CwZK7s1U.js"), "./pages/index.tsx": () => import("./assets/index-B8h3WvAy.js"), "./pages/piggy-banks/index.tsx": () => import("./assets/index-CxACsSlX.js"), "./pages/settings/appearance.tsx": () => import("./assets/appearance-2VZ4bxsx.js"), "./pages/settings/password.tsx": () => import("./assets/password-BcXa-dH3.js"), "./pages/settings/profile.tsx": () => import("./assets/profile-DaB9A2B1.js"), "./pages/subscriptions/index.tsx": () => import("./assets/index-D3WSdvqP.js"), "./pages/welcome.tsx": () => import("./assets/welcome-CtPb_rEB.js") })),
    setup: ({ App, props }) => {
